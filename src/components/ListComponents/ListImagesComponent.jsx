        ...
        <section className={styles.listImgs}>
            {
                listImages.map((img, index) => {
                    const image = new Img(img.id, img.description, img.width, img.height, img.urls.raw, img.likes, img.created_at, img.urls.full, img.links.download,`index__img__${index}`);
                    return (
