...
export const NavBarComponent = () => {
    ...
    return (
        <nav className={styles.nav}>
            <NavLink to="/" className={({isActive}) => isActive ? `${styles.navLink} ${styles.navLinkActive} ${styles.title}` : `${styles.navLink} ${styles.navLinkDark} ${styles.title}`}>ALPHOTOS</NavLink>
